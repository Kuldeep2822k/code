...
(() => {
    ...
    async initializeCharts() {
        try {
            ...
            // Show nutrition tab first
            const nutritionTabContent = document.querySelector('.tab-content[data-tab="nutrition"]');
            if (nutritionTabContent) {
                nutritionTabContent.style.display = 'block';
            }
            ...
            this.charts.weeklyTrend = new Chart(weeklyCtx, {
                ...
                data: {
                    ...
                    datasets: [
                        {
                            label: 'Calories (÷10)',
                            data: this.generateRandomData(7, 150, 250),
                        ...
                        {
                            label: 'Protein (g)',
                            data: this.generateRandomData(7, 40, 120),
                        ...
                        {
                            label: 'Carbs (g)',
                            data: this.generateRandomData(7, 100, 250),
    ...
    updateChartsWithCurrentData() {
        ...
        if (this.charts.mealBreakdown) {
            ...
            this.mealNames.forEach((mealName, index) => {
                const mealType = mealName.toLowerCase().replace(' ', '_');
